...
import ExecTerminalWithContent from "./components/Terminal.jsx";
...
export default function App() {
    ...
    return (
        <div className="container">
            <Navbar />
            <ExecTerminalWithContent></ExecTerminalWithContent>
            <GitHubLogin />
            <input
                type="text"
            ...
            <div className="editor-container">
                ...
                <div className="right-pane">
                    <TabButtons selectedTab={selectedTab} setSelectedTab={handleTabChange} />
                    <Editor
                        className="editor"
                        defaultLanguage="cpp"
                        value={asm}
